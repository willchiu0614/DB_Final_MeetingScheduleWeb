...
<?php
    ...
    */
        ...
        echo"<td ><input class='form-control form-control-sm' type='text' name='m_place' value=".$d1." ></td>";
        echo"<td ><textarea name='m_detail' class='form-control'   aria-label='With textarea' >".$d2."</textarea></td>";
